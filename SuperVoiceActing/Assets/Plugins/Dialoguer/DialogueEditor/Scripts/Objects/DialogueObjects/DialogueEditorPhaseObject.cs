...
namespace DialoguerEditor
{
    ...
    public class DialogueEditorPhaseObject
    {
        ...
        public string GetChoiceTranslation( int i )
        {
            if ( translatedChoices == null ) translatedChoices = new List<string>( i );
            if ( i >= translatedChoices.Count )
                translatedChoices.AddRange( new string[i - translatedChoices.Count + 1] );

            return translatedChoices[i];
        }

        public void SetChoiceTranslation( int i, string value )
        {
            if ( translatedChoices == null ) translatedChoices = new List<string>( i );
            if ( i >= translatedChoices.Count )
                translatedChoices.AddRange( new string[i - translatedChoices.Count + 1] );

            translatedChoices[i] = value;
        }
#endif
        ...
        public void addNewChoice()
        {
            ...
            if ( translatedChoices == null ) translatedChoices = new List<string>( 4 );
            translatedChoices.Add( string.Empty );
#endif
        }
...
#if I2Loc
            if ( translatedChoices == null ) translatedChoices = new List<string>( 4 );
            translatedChoices.RemoveAt( translatedChoices.Count - 1 );
#endif
        }
    }
    ...
    public class DialogueEditorPhaseType
    {
        ...
        private static Texture getIcon(string icon){
            ...
            string iconPath = "Assets/External Assets/Dialoguer/DialogueEditor/Textures/GUI/";
