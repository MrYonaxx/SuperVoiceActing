...
public class DialoguerEnumGenerator : EditorWindow {
    ...
    //[MenuItem("Assets/External Assets/Dialoguer/Generate Dialogues Enum", false, 1000)]
    static public void GenerateDialoguesEnum(){
        ...
        for(int i = 0; i<dialogues.Count; i+=1){
            ...
            lines.Add("\t"+varName+" = "+ dialogues[i].id + ",");
        }
        lines.Add("}");
        ...
        AssetDatabase.ImportAsset( @DialogueEditorFileStatics.ENUMS_PATH + DialogueEditorFileStatics.DIALOGUE_ENUMS_FILENAME );
