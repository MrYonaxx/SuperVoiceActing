...
namespace DialoguerEditor
{
    public class DialogueEditorGUI : MonoBehaviour
    {
        ...
        public static GUISkin gui
        {
            get
            {
                if ( __gui == null )
                {
                    ...
                    {
                        __gui = AssetDatabase.LoadAssetAtPath( "Assets/External Assets/Dialoguer/DialogueEditor/Skins/dialogueEditorSkinDark.guiskin", typeof( GUISkin ) ) as GUISkin;
                    }
                    else
                    {
                        __gui = AssetDatabase.LoadAssetAtPath( "Assets/External Assets/Dialoguer/DialogueEditor/Skins/dialogueEditorSkinLight.guiskin", typeof( GUISkin ) ) as GUISkin;
                    }
                }
                return __gui;
            }
        ...
        private static GUIStyle __selectedEntryStyle;
        public static GUIStyle selectedEntryStyle
        {
            get
            {
                if( __selectedEntryStyle == null )
                {
                    __selectedEntryStyle = new GUIStyle( GUI.skin.box );
                    /*
                    Texture2D backgroundTexture = new Texture2D( 10, 10 );
                    Color[] colors = new Color[100];
                    for ( int i = 0 ; i < 100 ; i++ )
                    {
                        if ( i < 10 || i > 90 || i % 10 == 0 || i % 10 == 9 )
                            colors[i] = Color.white;
                        else if ( i < 20 || i > 80 || i % 10 == 1 || i % 10 == 8 )
                            colors[i] = Color.clear;
                        else
                            colors[i] = Color.clear;
                    }
                    backgroundTexture.SetPixels( 0, 0, 10, 10, colors );
                    */
                    Texture2D backgroundTexture = new Texture2D( 1, 1 );
                    backgroundTexture.SetPixel( 0, 0, Color.white );
                    backgroundTexture.Apply();
                    __selectedEntryStyle.normal.background = __selectedEntryStyle.active.background = __selectedEntryStyle.focused.background = backgroundTexture;
                }
                return __selectedEntryStyle;
            }
        }
		...
		public static GUISkin editorGui{
			get{
				if(__editorGui == null){
					__editorGui = Resources.LoadAssetAtPath("Assets/External Assets/Dialoguer/DialogueEditor/Skins/EditorSkin.guiskin", typeof(GUISkin)) as GUISkin;
				}
				return __editorGui;
			}
		}
		*/
        ...
        public static Texture2D bezierTexture
        {
            get
            {
                ...
                {
                    __bezierTexture = AssetDatabase.LoadAssetAtPath( "Assets/External Assets/Dialoguer/DialogueEditor/Textures/GUI/Dark/bezier_texture.png", typeof( Texture2D ) ) as Texture2D;
                }
        ...
        public static Texture2D scrollboxBgTexture
        {
            get
            {
                ...
                {
                    __scrollboxBgTexture = AssetDatabase.LoadAssetAtPath( "Assets/External Assets/Dialoguer/DialogueEditor/Textures/GUI/Dark/scrollbox_bg.png", typeof( Texture2D ) ) as Texture2D;
        ...
        public static string toolbarIconPath
        {
            get
            {
                ...
                {
                    __toolbarIconPath = "Assets/External Assets/Dialoguer/DialogueEditor/Textures/GUI/";
