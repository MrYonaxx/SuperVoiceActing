						...
						case VariableEditorScopes.Global:
							switch(type){
								case VariableEditorTypes.Boolean:
									subPieces[0] = DialoguerDataManager.GetGlobalBoolean(variableId).ToString();
								break;
							
								case VariableEditorTypes.Float:
									subPieces[0] = DialoguerDataManager.GetGlobalFloat(variableId).ToString();
								break;
							
								case VariableEditorTypes.String:
									subPieces[0] = DialoguerDataManager.GetGlobalString(variableId);
								break;
							}
						break;
