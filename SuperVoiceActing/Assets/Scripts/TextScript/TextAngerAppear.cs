...
namespace VoiceActing
{
    ...
    /// </summary>
    public class TextAngerAppear : TextPerformanceAppear
    {
        #region Attributes 
        ...
        protected override IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    {
                        matrix = Matrix4x4.TRS(position, Quaternion.identity, Vector3.one + new Vector3(0, size, 0));
                    }
