...
namespace VoiceActing
{
    ...
    /// </summary>
    public class TextSadAppear : TextPerformanceAppear
    {
        #region Attributes 
        ...
        /*protected override IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Effet tristesse
                    if (vertAnim.offset > letterOffset)
                    {
                        position = vertAnim.vertexPosition + new Vector3(0, vertAnim.offset - (letterOffset * 1.5f), 0);
                        vertAnim.offset -= gravity;
                        vertAnim.vertexPosition = position;
                    }
                    else if (vertAnim.offset > 0)
                    {
                        position = vertAnim.vertexPosition - new Vector3(0, vertAnim.offset - (letterOffset * 0.5f), 0);
                        vertAnim.offset -= gravity;
                        vertAnim.vertexPosition = position;
                    }
                    else
                    {
                        //position = vertAnim.vertexPosition - new Vector3(0, vertAnim.offset - (letterOffset * 0.5f), 0);
                        vertAnim.offset = letterOffset * 2;
                        vertAnim.vertexPosition = position;
                    }
